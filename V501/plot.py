...
plt.xlabel(r"$\frac{1}{U_\mathrm{d}}\cdot 10^3$/$\si{\per\volt}$")
plt.xlim(2.2,6.0)
#plt.ylim(-2,14)
plt.legend()
plt.tight_layout()
...
plt.plot(x, params200[0]*x+params200[1], 'g-',label=r'Regression $U_\mathrm{D}=\SI{200}{Volt}$')
plt.plot(Ud200,D, 'gx', label=r'Messwerte $U_\mathrm{D}=\SI{200}{Volt}$')
plt.plot(x, params300[0]*x+params300[1], 'b-',label=r'Regression $U_\mathrm{D}=\SI{300}{Volt}$ ')
plt.plot(Ud300,D, 'bx', label=r'Messwerte $U_\mathrm{D}=\SI{300}{Volt}$')
plt.plot(x, params400[0]*x+params400[1], 'r-',label=r'Regression $U_\mathrm{D}=\SI{400}{Volt}$ ')
plt.plot(Ud400,D, 'rx', label=r'Messwerte $U_\mathrm{D}=\SI{400}{Volt}$')
