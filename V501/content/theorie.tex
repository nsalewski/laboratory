...
\end{equation}
Hinter der beschleunigenden Elektrode befindet sich ein regelbares Fokussierungssystem bestehend aus Elektroden verschiedener Potentiale (vgl. dazu \ref{fig:kathode}).
