...
\FloatBarrier
\subsection{Messung 2: Pendellänge $\SI{0.72}{\meter}$}
Für die Berechnung der Theoriewerte werden folgende fehlerbehaftete Größen verwendet:
\begin{gather*}
...
%%%%%%%%%%%%%%%%%%%
In Tabelle \ref{tab:beckham} finden sich die Messwerte für die Schwingungsdauern der gleich-und gegensinnigen Schwingung.
\begin{table}
	\centering
