...
\subsection{Messung der Frequenz $\upnu_{\matrm{0}}$ der Schallwelle bei ruhendem Lautsprecher}
...
\label{sec:frequenz}
In Abbildung \ref{fig:delphin} ist der prinzipielle Aufbau zur Bestimmung der Frequenz $\upnu_{\matrm{Q}}$ bei bewegter Quelle dargestellt.
...
Am Zählwerk kann die Frequenz $\upnu_{\mathrm{Q}}$ jetzt direkt abgelesen werden.
