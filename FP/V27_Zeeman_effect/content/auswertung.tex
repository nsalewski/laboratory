...
\subsection{Vorbereitende Aufgaben}
	...
	\eqref{eq:???} bestimmt. Dabei ist die Dicke der Platte $d=\SI{4}{\milli\meter}$
	...
	\end{align*}
	Für das Auflösungsvermögen $A$ ergeben sich mit Gleichung \eqref{eq:???} die Werte:
\begin{align*}
...
\subsection{Bestimmung der Landé-Faktoren $g$}
	Die Landé-Faktoren werden mit Formel \eqref{eq:???} bestimmt. Hierfür werden die mit der
