...
\begin{gather*}
	...
	b = (0,0525 \pm 0,0010) \, \si[per-mode=reciprocal]{\per\centi\meter} \text{.}
\end{gather*}
...
Damit erhält man für die Grenzfrequenz mittels einer Regression von $f_{\text{G}}$ mit python
\begin{equation*}
...
\begin{gather*}
	...
	b = (0,0525 \pm 0,0012) \, \si[per-mode=reciprocal]{\per\centi\meter} \text{.}
\end{gather*}
...
\begin{table}
	...
	\begin{tabular}{ccccc}
		\toprule
		Phasenverschiebung $\phi$/$\pi\si{\radian}$ & $f$/$\si{\kilo\Hz}$ & $\omega$/$\si{\kilo\Hz}$ & $\theta$/$\si{\radian}$ & $v_{\mathrm{Ph}}$/\si{\kilo\hertz\per\radian} \\
		\midrule
...
Die Grundschwingung, also die erste Eigenschwingung der $LC$-Kette, betrug $f_{\mathrm{0}}=7.5 \,\si{\kilo\Hz}$, die erste Oberschwingung, also die 2. Eigenschwingung betrug $f_{\mathrm{1}}=14.7 \,\si{\kilo\Hz}$.
...
Der erwartete Spannungsverlauf einer stehenden Cosinus-Welle ($\lvert \cos \rvert$) wird durch die Messdaten annähernd erreicht. Die stehende Welle weist bei der Grundschwingung einen Spannungsknoten etwa in der Mitte der $LC$-Kette auf, während an den Enden Spannungsbäuche auftreten.
