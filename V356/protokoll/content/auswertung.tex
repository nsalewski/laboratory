...
%z.B.
%Damit erhält man für die Grenzfrequenz mittels einer Regression von f(x) mit python/numpy \cite{numpy}
...
%%%%%%%%%%%%%%%%%%
%einer Ausgleichsrechnung mittels python/numpy \cite{numpy}
%%%%%%%%%%%%%%%%%%%%%%%%%
