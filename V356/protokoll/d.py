...
plt.plot(n1, u1, 'ro--', label="Messdaten 1. Eigenschwingung (7.5 \,\si{\kilo\Hz})")
...
plt.plot(n2, u2, 'ro--', label='Messdaten 2. Eigenschwingung (14.7\,\si{\kilo\Hz})')
plt.ylabel(r'Spannung $U$/$\si{\volt}$')
plt.xlabel(r'Nr. des $LC$-Kettenglieds')
plt.legend(loc='best')
plt.xlim(-1,14)
...
plt.plot(n3, u3, 'ro--', label='Messdaten zur 1. Eigenschwingung (7.5\,\si{\kilo\Hz})')
plt.ylabel(r'Spannung $U$/$\si{\volt}$')
plt.xlabel(r'Nr. des $LC$-Kettenglieds')
plt.legend(loc='best')
plt.xlim(-1,14)
