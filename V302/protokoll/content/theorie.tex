...
physikalischen Kennwerte eines unbekannten Widerstands oder einer anderen Impedanz zu bestimmen.
...
gleich der angelegten Gesamtspannung $U_0$ ist. Äquivalent dazu ist die Formulierung, dass die Summe aller auftretenden Spannungen $U_k$ gleich Null ist.
...
\end{equation}
 ...
 Stellt man das Ohmsche Gesetz nach $U$ um, ergitb sich der Zusammenhang
\begin{equation}
   \centering
   U=R \cdot I
 \end{equation}
...
\end{equation}
Die Abgleichbedingung hängt somit lediglich von den Widerständen ab. Somit lässt sich ein unbekannter Widerstand $R_x$ mittels der abgeglichenen Brücke bestimmen.

Dafür müssen die bekannten Widerstände mit möglichst großer Genauigkeit bekannt werden und mindestens einer der Widerstände muss sich regulieren lassen.
...
Die $R_x$ verursachen eine Phasenverschiebung.
...
In Schaltbild \ref{fig:wheatstonebrücke} ist die Wheatstonesche Brücke abgebildet. Diese enthält lediglich Ohmsche Widerstände. Daher kann sie sowohl mit Wechselstrom als auch mit Glecihstrom betrieben werden.
Der zu bestimmende Widerstand $R_x$ lässt sich nach \eqref{abgleichbedingung} über die anderen Widerstände wie folgt bestimmen:
\begin{equation}
  \centering
...
$R_x$ steht hierbei als gedachter Ersatz für die Wärmeverluste im Kondensator. Zum Abgleich des komplexen kapazitiven Widerstands wird also eine Ersatzschaltung verwendet.
Hierzu wird ein bekannter Kondensator $C_2$ in Reihe geschaltet zu einem regulierbaren ohmschen Widerstand $R_2$.
Diese Ersatzschaltung dient hierbei dazu, die Phasenverschiebung des gedachten Widerstandes $R_x$,
welcher die Wärmeverluste im zu messenden Kondensator darstellt, zu kompensieren. Für den $R_2-C_2$-Zweig wird hierbei angenommen, dass $R_{Wirk}=R_2$ gilt, also der Kondensator $C_2$ verlustfrei ist. Dies ist, wie sich auch anhand von $R_x$ nahezu 0 zeigt, realisierbar.
