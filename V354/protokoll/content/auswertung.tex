...
\begin{equation*}
	\text{Theorie}: 	\omega_+ - \omega_- \approx \frac{R}{L}\cdot \frac{1}{2\pi}=(8.81\pm 0.03) \cdot 10^{3} \,\si{\Hz} .
\end{equation*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}
	...
	\begin{tabular}{cccc}
		\toprule
		 &$\omega_1$ / $10^{3} \si{\Hz}$ &$\omega_{\mathrm{res}}$ / $10^{3} \si{\Hz}$&$\omega_2$ / $10^{3} \si{\Hz}$\\
		 \midrule
